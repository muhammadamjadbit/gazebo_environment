...
def generate_launch_description():
    ...
    declare_robot_x = DeclareLaunchArgument('robot_x', default_value='6.0')
    declare_robot_y = DeclareLaunchArgument('robot_y', default_value='-18.0')
    declare_robot_z = DeclareLaunchArgument('robot_z', default_value='2.0')
    declare_robot_yaw = DeclareLaunchArgument('robot_yaw', default_value='0')
