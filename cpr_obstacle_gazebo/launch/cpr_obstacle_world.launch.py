...
def generate_launch_description():
    ...
    # Robot spawn position arguments (start at corner for obstacle course)
    ...
    # Obstacle course starts at corner
    declare_robot_x = DeclareLaunchArgument('robot_x', default_value='-5.0')
    declare_robot_y = DeclareLaunchArgument('robot_y', default_value='-5.0')
