...
def generate_launch_description():
    ...
    declare_platform = DeclareLaunchArgument(
        'platform',
        default_value=EnvironmentVariable('CPR_GAZEBO_PLATFORM', default_value='husky'),
    ...
    declare_world_name = DeclareLaunchArgument(
        ...
        default_value=PathJoinSubstitution([
            FindPackageShare('cpr_agriculture_gazebo'),
            'worlds',
            'actually_empty_world.world'
        ])
    )
    
    # Set agriculture geometry parameter
    agriculture_geom_param = Node(
        package='robot_state_publisher',
        executable='robot_state_publisher',
        name='agriculture_geom_publisher',
        parameters=[{
        ...
        remappings=[('robot_description', 'agriculture_geom')]
    )
    ...
    # Spawn agriculture world geometry
